cask "whisper-type" do
  ...
  # TODO: Replace GITHUB_USER with your actual GitHub username
  url "https://github.com/GITHUB_USER/whisper-type/releases/download/v#{version}/WhisperType-v#{version}-arm64.dmg"
  name "WhisperType"
  desc "Local speech-to-text dictation for macOS, powered by whisper.cpp"
  homepage "https://github.com/GITHUB_USER/whisper-type"
